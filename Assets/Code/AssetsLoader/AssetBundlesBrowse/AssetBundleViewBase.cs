...
namespace AssetsLoader.AssetBundlesBrowse
{
    ...
    {
        private const string UrlAssetBundleSprites = "https://drive.google.com/uc?export=download&id=1ZEDgYaY5ggYg3Xt6F0b9ZcyE9F9Uw3-d";
        private const string UrlAssetBundleAudio = "https://drive.google.com/uc?export=download&id=1Qyas7ejKqJf4nVNbg9vMtHntrxvZCQNW";
